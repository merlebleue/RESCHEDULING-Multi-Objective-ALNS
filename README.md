...
In this case, I wrote an efficient algorithm for capacity-limited passenger assignment, considering multiple assumptions. I then developped multiple destroy and repair operators, which I incorporated into the [`biogeme-optimization`](https://github.com/michelbierlaire/optimization) framework and tested on a simplified case study, based on the dutch network and with two objectives.
